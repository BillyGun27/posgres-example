...
<div class="container" style="padding:10px;">
  ...
  <div class="form-group row">
    <label for="example-text-input" class="col-4 col-form-label">Kode Anggota</label>
    <div class="col-8">
      <input class="form-control inp" type="text" name="kd_anggota" required>
    </div>
  </div>
  <div class="form-group row">
          <label for="example-text-input" class="col-4 col-form-label">Unit Kerja</label>
          <div class="col-8">
          <select class="form-control inp" name="kd_unitkerja"  required>
              <?php include "routes/select/unitkerja.php"; ?>
          </select>
          </div>
        </div>
  <div class="form-group row">
          <label for="example-text-input" class="col-4 col-form-label">NPP</label>
          <div class="col-8">
          <input class="form-control inp" type="text" name="npp" required>
          </div>
      </div>
    <div class="form-group row">
        <label for="example-text-input" class="col-4 col-form-label">Nama Anggota</label>
        <div class="col-8">
        <input class="form-control inp" type="text" name="nm_anggota" required>
        </div>
    </div>
  ...
  <div class="col-5">
              <div class="form-group row">
                <label for="example-text-input" class="col-4 col-form-label">Tempat Tanggal Lahir</label>
                <div class="col-4">
                  <input class="form-control inp" type="text" name="tmp_lahir" required>
                </div>
               <div class="col-4">
                  <input class="form-control inp" type="date" name="tgl_lahir" required>
                </div>
              </div>
              <div class="form-group row">
                      <label for="example-text-input" class="col-4 col-form-label">Jenis Kelamin</label>
                      <div class="col-8">
                        <input class="form-control inp" type="text" name="jenis_kelamin" required>
                      </div>
                    </div>
              <div class="form-group row">
                <label for="example-text-input" class="col-4 col-form-label">Alamat</label>
                <div class="col-8">
                  <input class="form-control inp" type="text" name="alamat" required>
                </div>
              </div>
              <div class="form-group row">
                      <label for="example-text-input" class="col-4 col-form-label">Menjadi Anggota Mulai</label>
                      <div class="col-8">
                        <input class="form-control inp" type="date" name="tgl_jadi_anggota" required>
                      </div>
                    </div>
          </div>
    ...
    <script>
        ...
        $(".data_pengguna").load("routes/table/anggota.php");

        function search(keyword){
          $(".data_pengguna").load("routes/table/anggota.php?cari="+keyword);
        }
        ...
        $("#former").submit(function(event) {
                ...
                $.post("routes/manage/anggota.php",
            {
                submit: submit,
                kd_anggota :$(".inp").eq( 0 ).val() ,
                kd_unit_kerja_unit_kerja :$(".inp").eq( 1 ).val(),
