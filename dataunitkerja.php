...
<div class="container" style="padding:10px;">
  ...
  <div class="form-group row">
    <label for="example-text-input" class="col-4 col-form-label">Kode Unit Kerja</label>
    <div class="col-8">
      <input class="form-control inp" type="text" name="kd_unit_kerja" required>
    </div>
  </div>
  <div class="form-group row">
          <label for="example-text-input" class="col-4 col-form-label">Unit Kerja</label>
          <div class="col-8">
            <input class="form-control inp" type="text" name="unit_kerja" required>
          </div>
        </div>
    ...
    <script>
        ...
        $(".data_pengguna").load("routes/table/unitkerja.php");
        ...
        $("#former").submit(function(event) {
                ...
                $.post("routes/manage/unitkerja.php",
            {
                submit: submit,
