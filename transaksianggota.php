...
<div class="container" style="padding:10px;">
  <div class="row">
      <div class="col-12" style="background:white;text-align:right">
        <input class="form-control-plaintext total"  type="text" name="total_harga" value=0 readonly>
      </div>
  </div>
  <br>
  ...
  <div class="form-group row">
    ...
    <div class="form-group row">
        <label for="example-text-input" class="col-4 col-form-label">Diskon</label>
        <div class="col-6">
        <input class="form-control inp" type="number" name="diskon" value=0>
        </div>
        <div class="col-1">
        <h5>%</h5>
        </div>
  ...
  <div class="col-6">
        ...
        <div style="border:#B41F0A solid 3px;padding:10px;">
              <div class="form-group row">
                      ...
                      <div class="col-8">
                        <input class="form-control-plaintext" readonly type="text" name="anggota" value="umum" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="example-text-input" class="col-4 col-form-label">Nama Anggota</label>
                      <div class="col-8">
                        <input class="form-control nm_anggota" type="text" name="anggota" required>
                      </div>
                    </div>
              <div class="form-group row">
...
-->
    <button type="button" id="confirm" onclick="Confirmation();" class="btn btn-outline-danger sm-btn" style="position:absolute ;right:18%;" >Bayar</button> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Tunai Langsung</h5>
      ...
      <div class="modal-body">
        <div class="form-group row">
        <label for="text-input" class="col-5 col-form-label">Kode Tunai Langsung</label>
        <div class="col-7">
        <input class="form-control-plaintext " placeholder="kode belum di masukkan" readonly type="text" id="kd_penj_fix"  name="kd_tunai_langsung" >
        </div>
        </div>
        ...
        <div class="row" style="border:#B41F0A solid 3px;padding:10px;">
            ...
            <div class="form-group">
                <label for="text input">Anggota</label>
                <input type="text"  class="form-control-plaintext nm_anggota_fix" readonly name="Anggota"   required>
              </div>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-outline-danger sm-btn" >Ok</button>
    ...
    function PilihBarang(b){
      $.post("routes/select/detailbarang.php",
        ...
        function FormData(d){
          ...
          $(".inp").eq( 4 ).val( barang[$.parseHTML(d.html())[0].innerHTML].disc );
        ...
        var totalHarga = 0;
          ...
          for (var i = 0; i < barang.length; i++) {
            ...
            $("tbody.data_pengguna").append(
                  ...
                  +"<td>"+(barang[i].jumlah*barang[i].harga)* Disc+"</td>"
                  )
              )
            
            totalHarga += ((barang[i].jumlah*barang[i].harga)* Disc);
          }
        ...
        $("#former").submit(function(event) {
                ...
                $.post("routes/transaksi/anggota.php",
                {
                    total :$(".total").val(),
            ...
            $.post("routes/transaksi/cekanggota.php",
            {
                nm_anggota : $(".nm_anggota").val() 
            },
              function(data){
               if(data== "Data Anggota tidak ditemukan"){
                alert(data);
               }else {
                   $('.nm_anggota_fix').val( $(".nm_anggota").val() )
                   $("#kd_penj_fix").val( $("#kd_penj").val() )
                    $('#myModal').modal('toggle');
               }
